...
const JobCard: React.FC<JobCardProps> = ({
  ...
  return (
    ...
    >
      <Card className={`bg-card text-card-foreground border-border hover:bg-accent hover:text-accent-foreground transition-colors duration-200 ${priorityStyle.border} ${isActive ? 'ring-2 ring-primary ring-offset-2 ring-offset-background' : ''}`}>
